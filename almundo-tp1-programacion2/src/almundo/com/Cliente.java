...
public class Cliente extends Persona{
    ...
    public Cliente(String nombre, String apellido, String id_user, String Password, int Dni, String mail, String fecha) throws ParseException {
